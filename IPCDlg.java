...
public class IPCDlg extends JFrame implements BaseLayer {
	...
	public static void main(String[] args) {
		...
		m_LayerMgr.AddLayer(new ChatAppLayer("Chat")); // 과제- ChatApp LayerManager에 추가
		m_LayerMgr.AddLayer(new IPCDlg("GUI"));
		m_LayerMgr.ConnectLayers(" Socket ( *Chat ( *GUI ) ) "); // 과제 - ChatApp 연결하기 아래부분 수정 ->m_LayerMgr.ConnectLayers(" Socket ( *GUI ) ");
	}
